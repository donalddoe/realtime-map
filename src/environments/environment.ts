...
export const environment = {
 ...
 mapbox: {
  ...
  detailsUrl: 'https://app.smartapartmentdata.com/List/json/propertyItem.aspx?listID=5363950&token=5AE7DFB40500DDC03BC84BD3F0A8AC0F18784B1E&propertyID=74015'
};
